 ...
 * @function guessWrong
 * 
 * If the guess is wrong, then it sets the style of the "Too high!" or "Too low!" text to a colour based on proximity, corrects the number of attempts left or locks the game if there are no attempts left.
 */
